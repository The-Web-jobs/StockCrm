...
<aside class="left-sidebar" id="js-trigger-nav-team">
    ...
    <div class="scroll-sidebar" id="main-scroll-sidebar">
        ...
        <nav class="sidebar-nav" id="main-sidenav">
            <ul id="sidebarnav">
                ...
                <!--billing-->
                <?php if(auth()->user()->role->role_invoices >= 1 || auth()->user()->role->role_invoices >= 1 ||
                auth()->user()->role->role_estimates >= 1 || auth()->user()->role->role_items >= 1 ||
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/nav/leftmenu-team.blade.php ENDPATH**/ ?>