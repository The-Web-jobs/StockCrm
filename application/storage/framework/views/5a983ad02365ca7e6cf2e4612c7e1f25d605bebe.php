<div class="row">
    <div class="col-lg-12">
        ...
        <!--due date-->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.target_date'))); ?></label>
            <div class="col-sm-12 col-lg-9">
...
</div><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/pages/tasks/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>