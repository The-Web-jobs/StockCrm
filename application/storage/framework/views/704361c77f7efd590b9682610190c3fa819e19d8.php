...
<form class="form" id="settingsFormStripe">
    ...
    <div class="form-group row">
        <label class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.webhooks_url'))); ?>*
            <span class="align-middle text-themecontrast font-16" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.stripe_api_instructions'))); ?>"
            data-placement="top"><i class="ti-info-alt"></i></span>
        </label>
        <div class="col-12">
    ...
    <div>
        <div class="p-b-10"><strong><small>* <?php echo e(cleanLang(__('lang.required'))); ?> </small></strong></div>
    ...
    <div class="alert alert-danger m-t-20"><?php echo e(cleanLang(__('lang.read_documentation_for_instructions'))); ?></div>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/pages/settings/sections/stripe/page.blade.php ENDPATH**/ ?>