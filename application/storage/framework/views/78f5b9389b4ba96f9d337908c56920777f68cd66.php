...
<tr id="project_<?php echo e($project->project_id); ?>">
    ...
    <?php endif; ?>
    <td class="projects_col_id"><a href="/projects/<?php echo e($project->project_id); ?>"><?php echo e($project->project_id); ?></label></a>
    </td>
    ...
    <td class="projects_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.delete'))); ?>"
                ...
                data-ajax-type="DELETE" data-url="<?php echo e(url('/')); ?>/projects/<?php echo e($project->project_id); ?>">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            <button type="button" id="listTableAction" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                title="<?php echo e(cleanLang(__('lang.more'))); ?>" class="data-toggle-action-tooltip btn btn-outline-default-light btn-circle btn-sm">
                <i class="ti-more"></i>
            </button>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/pages/projects/components/table/ajax.blade.php ENDPATH**/ ?>