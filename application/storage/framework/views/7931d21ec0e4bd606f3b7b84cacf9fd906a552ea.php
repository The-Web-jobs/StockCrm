...
<div class="kanban-card show-modal-button reset-card-modal-form js-ajax-ux-request" data-toggle="modal"
    ...
    <div class="x-meta">
        ...
        <div><label class="label label-light-info p-t-3 p-b-3 p-r-8 p-l-8"><?php echo e(runtimeMoneyFormat($lead->lead_value)); ?></label></div>
        <?php endif; ?>

        <!--telephone-->
        <?php if(config('system.settings_leads_kanban_telephone') == 'show'): ?>
        <span class="wordwrap"><strong><?php echo e(cleanLang(__('lang.telephone'))); ?>:</strong> <?php echo e($lead->lead_phone ?? '---'); ?></span>
        <?php endif; ?>
        <!--date created-->
        ...
        <span><strong><?php echo e(cleanLang(__('lang.contacted'))); ?>:</strong> <?php echo e(runtimeDate($lead->lead_last_contacted )); ?></span>
        <?php endif; ?>
        <!--category-->
        ...
        <span class="wordwrap"><strong><?php echo e(cleanLang(__('lang.email'))); ?>:</strong> <?php echo e($lead->lead_email ?? '---'); ?></span>
        <?php endif; ?>
        <!--source-->
        <?php if(config('system.settings_leads_kanban_source') == 'show'): ?>
        <span class="wordwrap"><strong><?php echo e(cleanLang(__('lang.source'))); ?>:</strong> <?php echo e($lead->lead_source ?? '---'); ?></span>
        <?php endif; ?>
    </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/pages/leads/components/kanban/card.blade.php ENDPATH**/ ?>