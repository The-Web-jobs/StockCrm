...
<tr id="timesheet_<?php echo e($timesheet->timer_id); ?>">
    ...
    <td class="timesheets_col_task">
        <a class="show-modal-button reset-card-modal-form js-ajax-ux-request" href="javascript:void(0)"
            ...
            data-loading-target="main-top-nav-bar"><?php echo e(str_limit($timesheet->task_title ?? '---', 45)); ?></a>
    </td>
    <?php if(config('visibility.timesheets_col_related')): ?>
    <td class="timesheets_col_related">
        <?php if($timesheet->timer_projectid > 0): ?>
        <a
            href="/projects/<?php echo e($timesheet->timer_projectid); ?>"><?php echo e(str_limit($timesheet->project_title ?? '---', 45)); ?></a>
        <?php else: ?>
        <a href="/leads/<?php echo e($timesheet->timer_leadid); ?>"><?php echo e(str_limit($timesheet->lead_title ?? '---', 45)); ?></a>
        <?php endif; ?>
    </td>
    <?php endif; ?>
...
<!--each row-->
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/pages/timesheets/components/table/ajax.blade.php ENDPATH**/ ?>