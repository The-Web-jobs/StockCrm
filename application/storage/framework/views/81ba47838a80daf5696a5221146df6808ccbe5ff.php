            ...
            <div class="r-panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <select name="filter_lead_status" id="filter_lead_status"
                                    ...
                                    <option value="<?php echo e($status->leadstatus_id); ?>"><?php echo e(runtimeLang($status->leadstatus_title)); ?>
                ...
                <div class="filter-block">
                    ...
                    <div class="fields">
                        <div class="row">
                            <div class="col-md-6">
                                <input type="number" class="form-control form-control-sm" placeholder="<?php echo e(cleanLang(__('lang.minimum'))); ?>"
                                    name="filter_lead_value_min" id="filter_lead_value_min">
                            </div>
                            <div class="col-md-6">
                                <input type="number" class="form-control form-control-sm" placeholder="<?php echo e(cleanLang(__('lang.maximum'))); ?>"
                ...
                <div class="buttons-block">
                    ...
                    <button type="button" class="btn btn-rounded-x btn-danger js-ajax-ux-request apply-filter-button"
                        data-url="<?php echo e(urlResource('/leads/search')); ?>"
...
<!--sidebar--><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/pages/leads/components/misc/filter-leads.blade.php ENDPATH**/ ?>