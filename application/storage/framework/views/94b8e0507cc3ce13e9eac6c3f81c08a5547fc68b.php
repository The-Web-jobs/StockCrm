...
<div class="form-group row">
    <label class="col-12 text-left control-label col-form-label required"><?php echo e(cleanLang(__('lang.category_name'))); ?></label>
    <div class="col-12">
...
<div class="form-group row">
    ...
    <div class="col-12">
        <select class="select2-basic form-control form-control-sm" id="kbcategory_visibility"
            ...
            <option value="team" <?php echo e(runtimePreselected('team', $category->kbcategory_visibility ?? '')); ?>><?php echo e(cleanLang(__('lang.team'))); ?>
...
<div class="line"></div>
<div class="form-group row">
    <label class="col-12 text-left control-label col-form-label required"><?php echo e(cleanLang(__('lang.move_artiles_to_another_category'))); ?> (<?php echo e(cleanLang(__('lang.optional'))); ?>)</label>
    <div class="col-12">
...
<?php endif; ?><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/pages/settings/sections/knowledgebase/modals/add-edit-inc.blade.php ENDPATH**/ ?>