    ...
    <div class="x-section">
        ...
        <!--status-->
        <div class="x-element" id="card-lead-status"><i class="mdi mdi-flag"></i> <span><?php echo e(cleanLang(__('lang.status'))); ?>: </span>
            <?php if($lead->permission_edit_lead): ?>
        ...
        <!--category-->
        <div class="x-element" id="card-lead-category"><i class="mdi mdi-folder"></i> <span><?php echo e(cleanLang(__('lang.category'))); ?>:
            </span>
            <?php if($lead->permission_edit_lead): ?>
        ...
        <!--last contacted-->
        <div class="x-element" id="lead-contacted"><i class="mdi mdi-message-text"></i> <span><?php echo e(cleanLang(__('lang.contacted'))); ?>:
            </span>
            <?php if($lead->permission_edit_lead): ?>
            <span class="x-highlight x-editable card-pickadate"
        ...
        <!--Source-->
        <div class="x-element" id="card-lead-source"><i class="mdi mdi-magnify-plus"></i> <span><?php echo e(cleanLang(__('lang.source'))); ?>:
            </span>
            <?php if($lead->permission_edit_lead): ?>
    ...
    </div><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/pages/lead/rightpanel.blade.php ENDPATH**/ ?>