...
<tr id="team_<?php echo e($team->id); ?>">
    <td class="team_col_first_name">
        ...
        <span class="sl-icon-star text-warning p-l-5" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.main_administrator'))); ?>"
            id="team_admin_<?php echo e($team->id); ?>"></span>
        <?php endif; ?>
    </td>
    ...
    <td class="team_col_action">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.delete'))); ?>"
                ...
                data-ajax-type="DELETE" data-url="<?php echo e(url('/')); ?>/team/<?php echo e($team->id ?? ''); ?>">
...
<!--each row--><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/pages/team/components/table/ajax.blade.php ENDPATH**/ ?>