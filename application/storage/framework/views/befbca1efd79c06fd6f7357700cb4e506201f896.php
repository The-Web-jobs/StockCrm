            ...
            <table>
                <tbody>
                    <tr>
                        <td class="x-left">
                            <div class="x-logo">
                                <img src="storage/logos/app/<?php echo e(config('system.settings_system_logo_large_name')); ?>">
                            </div>
                        </td>
                        <td class="x-right">
                    ...
                    <tr>
                        ...
                        <td class="x-left">
                            <div class="x-company-name">
                                <h5 class="p-b-0 m-b-0"><strong><?php echo e(config('system.settings_company_name')); ?></strong></h5>
                            </div>
...
</html><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/pages/bill/bill-pdf.blade.php ENDPATH**/ ?>