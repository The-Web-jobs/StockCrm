<div class="row" id="js-projects-modal-add-edit" data-section="<?php echo e($page['section']); ?>">
    <div class="col-lg-12">
        ...
        <div class="modal-meta-data">
            <small><strong><?php echo e(cleanLang(__('lang.created_by'))); ?>:</strong> <?php echo e($project->first_name ?? runtimeUnkownUser()); ?> |
        ...
        <?php if(config('visibility.project_modal_assign_fields')): ?>
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.manager'))); ?> <a
        ...
        <div class="hidden" id="edit_project_setings">
            ...
            <div id="edit_project_permissions_tasks" class="hidden highlighted-panel">
                ...
                <div><small class="text-bold">** <?php echo e(cleanLang(__('lang.if_items_selected_then_viewing_perm'))); ?></small></div>
            </div>
            <!--permissions-->
            <?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/pages/projects/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>