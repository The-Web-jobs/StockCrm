<head>
    ...
    -->
        <link rel="apple-touch-icon" sizes="57x57" href="/storage/logos/app/logo.png">
    <link rel="apple-touch-icon" sizes="60x60" href="/storage/logos/app/logo.png">
    <link rel="apple-touch-icon" sizes="72x72" href="/storage/logos/app/logo.png">
    <link rel="apple-touch-icon" sizes="76x76" href="/storage/logos/app/logo.png">
    <link rel="apple-touch-icon" sizes="114x114" href="/storage/logos/app/logo.png">
    <link rel="apple-touch-icon" sizes="120x120" href="/storage/logos/app/logo.png">
    <link rel="apple-touch-icon" sizes="144x144" href="/storage/logos/app/logo.png">
    <link rel="apple-touch-icon" sizes="152x152" href="/storage/logos/app/logo.png">
    <link rel="apple-touch-icon" sizes="180x180" href="/storage/logos/app/logo.png">
    <link rel="icon" type="image/png" sizes="192x192" href="/storage/logos/app/logo.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/storage/logos/app/logo.png">
    <link rel="icon" type="image/png" sizes="96x96" href="/storage/logos/app/logo.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/storage/logos/app/logo.png">
...
</head><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/layout/header.blade.php ENDPATH**/ ?>