        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm" id="client_status" name="client_status">
                    <option></option>
                    <option value="active" <?php echo e(runtimePreselected($client->client_status ?? '', 'active')); ?>><?php echo e(cleanLang(__('lang.active'))); ?></option>
                    <option value="suspended" <?php echo e(runtimePreselected($client->client_status ?? '', 'suspended')); ?>><?php echo e(cleanLang(__('lang.suspended'))); ?>
...
</div><?php /**PATH /home/gi8l84000zs4/Crmstock.io/application/resources/views/pages/clients/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>